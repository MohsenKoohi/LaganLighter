...
### Bugs & Support
As "we write bugs that in particular cases have been tested to work correctly", we try to evaluate and validate the algorithms and their implementations. If you receive wrong results or you are suspicious about parts of the code, please [contact us]([https://blogs.qub.ac.uk/DIPSA/LaganLighter](https://orcid.org/0000-0002-7465-8003)) or [submit an issue](https://github.com/DIPSA-QUB/LaganLighter/issues). 
